  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.header}>
        <div className={styles.courseTag}>CSCE 314 &mdash; IO, Functors &amp; Monads</div>
...
function getGrade(pct) {
  if (pct >= 90) return { grade: 'A', color: '#4ade80', msg: 'Outstanding — you clearly know your IO, Functors, and Monads!' }
  if (pct >= 80) return { grade: 'B', color: '#a3e635', msg: 'Solid work. A few gaps, but mostly there.' }
  if (pct >= 70) return { grade: 'C', color: '#facc15', msg: 'Decent. Review the monad laws and how >>= chains computations.' }
